...
configuration_options =
{
    ...
    { name = "FFFFFFF",label = "",hover = "",options = {{description = "", data = 0}},default = 0, },

    {
      name = "MP_Limit_and_Defense",
      label = "法力上限和防御",
      hover = "MP Limit and Defense" ,
      options =  {
        {description = "默认 70%", data = 0.7},
        {description = "变态 95%", data = 0.95},
        {description = "不要脸 99.9%", data = 0.99},
      },
      default = 0.7,
    },
    {
      name = "intoxicated",
      label = "入醉度 intoxicated",
      hover = " 喝到多少就进入醉酒状态 \n how much you've had to drink to become drunk" ,
      options =  {
        {description = "小趴菜 1", data = 1},
        {description = "一般 3", data = 3},
        {description = "酒鬼 7", data = 7},
        {description = "酒仙 14", data = 14},
      },
      default = 3,
    },
