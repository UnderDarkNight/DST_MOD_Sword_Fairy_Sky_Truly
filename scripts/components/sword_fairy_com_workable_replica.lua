...
--------------------------------------------------------------------------------------------------------------
--- test 函数
    function sword_fairy_com_workable:SetTestFn(fn)
        if type(fn) == "function" then
            self._test_fn = fn
        end
    end

    function sword_fairy_com_workable:Test(doer,right_click)
        if self.inst:HasTag("sword_fairy_com_workable_can_not_work") then
            return false
        end
...
--------------------------------------------------------------------------------------------------------------
--- DoPreActionFn
    function sword_fairy_com_workable:SetPreActionFn(fn)
        if type(fn) == "function" then
            self.__pre_action_fn = fn
        end
    end
    function sword_fairy_com_workable:DoPreAction(doer)
...
--------------------------------------------------------------------------------------------------------------
--- sg
    function sword_fairy_com_workable:SetSGAction(sg)
        self.sg = sg
    end
    function sword_fairy_com_workable:GetSGAction()
        return self.sg
    end
--------------------------------------------------------------------------------------------------------------
--- 显示文本
    function sword_fairy_com_workable:SetText(index,str)
        self.str_index = string.upper(index)
        self.str = str
        STRINGS.ACTIONS.SWORD_FAIRY_COM_WORKABLE_ACTION[self.str_index] = str
    end

    function sword_fairy_com_workable:GetTextIndex()
